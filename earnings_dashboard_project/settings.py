"""
Django settings for earnings_dashboard_project project.
...
SECRET_KEY = 'django-insecure-8658rbr)rz2_mtmbd3cxfgap2(awi4w3a)ktmohhplr043%%l^'
...
INSTALLED_APPS = [
    ...
    'import_export',
    'accounts',
    'earnings_dashboard_app.apps.EarningsDashboardAppConfig',
]
...
ROOT_URLCONF = 'earnings_dashboard_project.urls'
...
WSGI_APPLICATION = 'earnings_dashboard_project.wsgi.application'
...
BOOTSTRAP5 = {
    ...
    "theme_url": STATIC_URL + 'css/bootstrap-theme.css',
